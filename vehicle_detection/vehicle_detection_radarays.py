...
# root_path = '/media/amock/SanDiskAlex/datasets/radiate'
# sequence_name = 'junction_1_11'

root_path = '/home/amock/mulran_radiate_format'
sequence_name = 'kaist02_navtech'
# sequence_name = 'kaist02_radarays'
...
# load sequence
seq = radiate.SequenceRadarOnly(os.path.join(root_path, sequence_name), config_file='../config/config.yaml')

cfg = get_cfg()
# add project-specific config (e.g., TensorMask) here if you're not running a model in detectron2's core library
cfg.merge_from_file(os.path.join('test','config' , network + '.yaml'))
# cfg.MODEL.DEVICE = 'cpu'
cfg.MODEL_DEVICE = 'gpu'
